...
contract BurnableToken is BasicToken { 
    ...
    */
    ...
    function burn(uint256 _value) public { require(_value <= balances[msg.sender]); 
...
{ 
    string public constant name = 'KHALSA'; 
    string public constant symbol = 'KHALSA'; 
...
{ 
    ...
    uint256 public date_start = 1527359400; 
    uint256 public date_end = 1535653800; 
    uint256 public hard_cap = 3735 ether; 
    uint256 public rate = 660; 
    address public funds_address = address(0x7224A3e9B510a0ad90168140CbdDAD9617f8CD76); 
